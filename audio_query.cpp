...
int main()
{
    ...
    if (curl)
    {
        curl_easy_setopt(curl, CURLOPT_URL, "http://localhost:50021/audio_query?text=a&speaker=1");
    ...
    if (curl)
    {
        curl_easy_setopt(curl, CURLOPT_URL, "http://localhost:50021/synthesis?speaker=1");
        curl_easy_setopt(curl, CURLOPT_POST, 1L);
